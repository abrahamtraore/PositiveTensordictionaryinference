...
BASE_PATH = '/home/arakoto/recherche/casacnn/dcase2016/dcase16-cqt.h5' 
...
BASE_PATH='/home/arakoto/recherche/casacnn/dcase2016/dcase16-cqt.h5.test'
with h5py.File(BASE_PATH,'r') as hf:
        data=hf.get('x')
...
folds=np.array([0,1,2,3],dtype=np.int32)
...
for numfold in folds:
   ...
   print('shape',Tensor_train.shape)
