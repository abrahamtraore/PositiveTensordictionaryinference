...
#       print(y_train.shape)
      ...
      C_svm,G_svm,lambdainfo,lambdaG,lambdaAf,lambdaAt,lambdaBf,lambdaBt,matrix=MethodsTSPenTestAB.Cross_valTSPen(Tensor,labels,C_values,G_values,Lambda_info,LambdaG,Lambda_Af,Lambda_At,Lambda_Bf,Lambda_Bt,T,nbclasses,kf,kt,maximum_iterations,tol,InitStrat,parallel_decision,pool)
