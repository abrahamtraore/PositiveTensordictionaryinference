...
for i in range(5):
   ...
   for trainvalid_index, test_index in skf.split(vector_all_features,labels):
       ...
       C_svm,G_svm,lambdainfo,lratio,alpha,matrix=MethodsTSPen.Cross_valNMF_PG(Tensor_valid,y_valid,C_values,G_values,Lambdainfo,Alpha,Lratio,Kd,nbclasses,pool,pool_decision)
