...
# -*- coding: utf-8 -*-
"""
Created on Sun Aug 13 04:09:35 2017
...
for train_index, test_index in skf.split(vector_all_features,labels):
    ...
    C_svm,G_svm,hyperparam,matrixscore=Methods.Cross_valHALs(Tensor_train,y_train,C_values,G_values,Hyper_values,nbclasses,kf,kt,maximum_iterations,tol)
