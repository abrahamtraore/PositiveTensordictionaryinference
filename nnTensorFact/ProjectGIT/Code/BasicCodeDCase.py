...
for numfold in folds:
   ...
   C_svm,G_svm,hyperparam,matrixscore=Methods.Cross_val(Tensor_val,y_val,C_values,G_values,Hyper_values,nbclasses,kf,kt,maximum_iterations,tol,InitStrat,parallel_decision,pool)
   ...
   del result
   del indexes
   del number_of_samples_per_class
   del Test_features
