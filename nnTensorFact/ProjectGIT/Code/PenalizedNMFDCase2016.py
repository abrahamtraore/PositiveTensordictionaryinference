...
# -*- coding: utf-8 -*-
"""
Created on Thu Sep  7 16:45:46 2017
...
for numfold in folds:
    ...
    C_svm,G_svm,hyperparam,matrix=Methods.Cross_valNMFPenalized(Tensor_val,y_val,C_values,G_values,Hyper_values,Kd,nbclasses,pool)
